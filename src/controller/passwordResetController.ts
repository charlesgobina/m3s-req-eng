...
export class PasswordResetController {
  ...
  async requestPasswordReset(req: Request<{}, {}, RequestPasswordResetBody>, res: Response) {
    try {
  ...
  async verifyResetCode(req: Request<{}, {}, VerifyResetCodeBody>, res: Response) {
    try {
  ...
  async confirmPasswordReset(req: Request<{}, {}, ConfirmPasswordResetBody>, res: Response) {
    try {
