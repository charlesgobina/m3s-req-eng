...
export class MemoryService {
  ...
  private stepMemories: Map<string, StepMemory> = new Map();
  ...
  async getStepMemory(
    ...
    const stepMemory = new StepMemory(
      userId,
      taskId,
      subtaskId,
      stepId,
  ...
  async getUniversalContext(
    ...
    return await this.vectorMemory.getComprehensiveContext(
      userId,
      agentRole,
      userQuestion,
      fullStepId
  ...
  async saveInteraction(
    ...
    await this.vectorMemory.saveInteraction(
      userId,
      agentRole,
      userMessage,
      agentResponse,
   ...
   */
  private async cleanupOldStepMemories(userId: string): Promise<void> {
