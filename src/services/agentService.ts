            ...
            steps: [
              {
                ...
                objective:
                  "Talk to the student agent to understand student problems with current learning systems. Identifies at least 2 specific problems students face with current systems",
                isCompleted: false,
                studentResponse: "",
                validationCriteria: [
              ...
              },
              {
                ...
                objective:
                  "Talk to the lecturer agent to understand lecturer challenges in teaching. Identifies at least 2 specific challenges lecturers face in their teaching work",
                isCompleted: false,
                studentResponse: "",
                validationCriteria: [
            ...
            steps: [
              {
                ...
                objective:
                  "Look for patterns and common problems across different stakeholder groups. You can always refer back to the interviews you conducted earlier or ask Lisa for help at any time. Identifies at least 2 common themes or problems that affect students and lecturers",
                isCompleted: false,
                studentResponse: "",
                validationCriteria: [
              ...
              },
              {
                ...
                objective:
                  "Understand which problems are most important to solve. You need to talk to Lisa to get her insights on the impact of each problem. List at least 3 most important problems to solve",
                isCompleted: false,
                studentResponse: "",
                validationCriteria: [
        ...
        subtasks: [
          {
            ...
            steps: [
              ...
              },
              {
                ...
                step: "Create user stories",
                objective:
                  "Write 3 user stories that describe features from the teacher's perspective. As always, you should talk with David, the UX designer, to help you with this. Follow the format: As a [role], I want [goal] so that [benefit].",
                isCompleted: false,
                studentResponse: "",
                validationCriteria: [
                  "Creates at least 3 user stories in the format: As a [role], I want [goal] so that [benefit]",
