...
export const RedisKeys = {
    ...
    CONVERSATION: (userId, taskContext) => `conv:${userId}:${taskContext}`,
    // Context cache: "ctx:user123:ProjectGuide:task1"
    CONTEXT: (userId, agentRole, taskId) => `ctx:${userId}:${agentRole}:${taskId}`,
    // User data cache: "user:user123:data"
    USER_DATA: (userId) => `user:${userId}:data`,
    // Agent insights: "insights:user123:ProjectGuide"
    AGENT_INSIGHTS: (userId, agentRole) => `insights:${userId}:${agentRole}`,
};
